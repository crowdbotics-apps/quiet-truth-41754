"""
Django settings for quiet_truth_41754 project.
...
ROOT_URLCONF = 'quiet_truth_41754.urls'
...
WSGI_APPLICATION = 'quiet_truth_41754.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_truth_41754 API",
    "DESCRIPTION": "API documentation for quiet_truth_41754 App",
    "VERSION": "v1",
}
